...
- Do not use the american writist tradition of having two spaces after a sentence
  #+begin_src emacs-lisp
...
** agenda
   ...
   #+BEGIN_SRC emacs-lisp
     (setq org-agenda-files
           '("~/Org/organizer.org"
             ;; "~/Dropbox/Org-Zettelkasten/Roam/Literaturnotizen.org"
             ))
...
#+begin_src emacs-lisp :results silent
  (setq org-agenda-custom-commands
        '(("z" "Zettelkasten todos" alltodo ""
           ((org-agenda-files '("~/Dropbox/Org-Zettelkasten/Notizen.org"))
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org-capture
       ...
       (setq org-capture-templates '(("o" "Organizer Workflow")
                                     ...
                                     ("zl" "Link" entry (file "~/Dropbox/Org-Zettelkasten/Notizen.org")
                                           "* TODO %a %?\n %T\n %i")
...
#+END_SRC
** org-mime
Lets write html emails directly out of org mode
#+begin_src emacs-lisp
...
** ox-latex
   #+BEGIN_SRC emacs-lisp
     (use-package ox-latex
       ...
       (org-cite-csl-styles-dir '"/home/frosch03/.emacs.d/csl-styles")

       (org-cite-global-bibliography
        '("/home/frosch03/Dropbox/Org-Zettelkasten/Roam/Literaturnotizen/Literatur.bib"))

       (org-cite-export-processors
        '((latex  biblatex)                                 ; For humanities
          (md  . (csl "chicago-fullnote-bibliography.csl")) ; Footnote reliant
          (odt . (csl "chicago-fullnote-bibliography.csl")) ; Footnote reliant
          (t   . (csl "ieee-with-url.csl"))))               ; Fallback
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sr/format-description (file)
  ...
  (defun my-sitemap-format-entry (entry style project)
    "Format for sitemap ENTRY, as a string.
                        ...
                        STYLE is the style of the sitemap.
                        PROJECT is the current project."

    (format "[[file:%s][%s]]
                             ,#+HTML: <p class='description'>%s</p>
                             ,#+HTML: <p class='date'>%s</p>"
            entry
            (org-publish-find-title entry project)
            (sr/format-description entry)
  ...
  (setq org-publish-project-alist
        '(
          ("deploy blog local"
           :components ("local-blog-posts" "local-blog-static" "local-blog-images" "local-blog-data"))

          ("deploy blog online"
           :components ("blog-posts" "blog-static" "blog-images" "blog-data"))

          ("blog-posts"
           :base-directory "~/Dropbox/Blog/posts/"
           :base-extension "org"
           :html-extension "html"
           :publishing-directory "/ssh:frosch03@dipling.cloud:/home/docker/frosch03_nginx/data/posts/"
           ...
           :html-preamble "
                                         <div class=\"navbar-header\" id=\"bs-example-navbar-collapse-1\">
                                           <ul class=\"nav navbar-nav\">
                                             <li class=\"active page\"><a href=\"https://frosch03.de/\">Home</a></li>
          ...
          ("blog-static"
           :base-directory "~/Dropbox/Blog/static/"
           :base-extension "css\\|js"
           :publishing-directory "/ssh:frosch03@dipling.cloud:/home/docker/frosch03_nginx/data/posts/static/"
           :recursive t
           :publishing-function org-publish-attachment
           )

          ("blog-images"
           :base-directory "~/Dropbox/Blog/images/"
           :base-extension "png\\|jpg\\|gif\\|svg"
           :publishing-directory "/ssh:frosch03@dipling.cloud:/home/docker/frosch03_nginx/data/posts/images/"
           :recursive t
           :publishing-function org-publish-attachment
           )

          ("blog-data"
           :base-directory "~/Dropbox/Blog/data/"
           :base-extension "pdf"
           :publishing-directory "/ssh:frosch03@dipling.cloud:/home/docker/frosch03_nginx/data/posts/data/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          ...
          ("local-blog-posts"
           ...
           :base-extension "org"
           :html-extension "html"
           :publishing-directory "~/Documents/local-blog/"
           :publishing-function org-html-publish-to-html
           :recursive t
           :section-numbers nil
           :with-sub-superscript {}
           ...
           :html-preamble "
                                         <div class=\"navbar-header\" id=\"bs-example-navbar-collapse-1\">
                                           <ul class=\"nav navbar-nav\">
                                             <li class=\"active page\"><a href=\"file:///home/frosch03/Documents/local-blog/index.html\">Home</a></li>
                                             <li class=\"active\"><a href=\"https://github.com/frosch03\">Github</a></li>
                                             <li class=\"active\"><a href=\"https://social.frosch03.de/@frosch03\">Mastodon</a></li>
                                           </ul>
                                         </div>"
          ...
          ("local-blog-images"
           :base-directory "~/Dropbox/Blog/images/"
           :base-extension "png\\|jpg\\|gif\\|svg"
           :publishing-directory "~/Documents/local-blog/images/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          ...
          ("local-blog-data"
           :base-directory "~/Dropbox/Blog/data/"
           :base-extension "pdf"
           :publishing-directory "~/Documents/local-blog/data/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          ...
          ("local-blog-static"
           :base-directory "~/Dropbox/Blog/static/"
           :base-extension "css\\|js"
           :publishing-directory "~/Documents/local-blog/static/"
           :recursive t
           :publishing-function org-publish-attachment
           )
          )
...
#+begin_src emacs-lisp
  (use-package ebib
    ...
    (ebib-bib-search-dirs '("/home/frosch03/Dropbox/Org-Zettelkasten/Roam/Literaturnotizen/"))
