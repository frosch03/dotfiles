...
Accrding to [[https://github.com/daviwil/emacs-from-scratch/blob/master/show-notes/Emacs-Mail-05.org][daviwil]]s mu4e workflow, with the following custom actions,
